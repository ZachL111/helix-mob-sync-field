"""Regression checks for the helix-mob-sync-field casebook."""
...
from casebook.harness import assert_expected, helix_mob_sync_field_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(helix_mob_sync_field_summary(), assert_expected())
