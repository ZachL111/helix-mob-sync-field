...
helix-mob-sync-field is a Go project for mobile workflows. It focuses on this technical goal: Create a Go reference implementation for sync workflows, centered on policy evaluation, deny and allow fixtures, and explainable decision traces.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 172, risk penalty 5, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
